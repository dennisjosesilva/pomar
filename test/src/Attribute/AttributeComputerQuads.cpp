...
SCENARIO("Quads attribute computer should count bit-quads for all nodes of a component tree.") {
  GIVEN("A component tree 'ct' built from a image 'f'.") {
    ...
    AttributeComputerQuads<unsigned char> attrComputer{"../../resource/pomar"};
    WHEN("The computed method is called.") {
      auto attr = attrComputer.compute(ct);
      
      THEN("The quantity of Q1 quads for each component tree node should be computed") {
        auto attr = attrComputer.compute(ct);
      ...
      THEN("The quantity of Q2 quads for each component tree node should be computed") {
      ...
      THEN("The quantity of Q3 quads for each component tree node should be computed") {
      ...
      THEN("The quantity of Q4 quads for each component tree node should be computed") {
      ...
      THEN("The quantity of QD quads for each component tree node should be computed") {
